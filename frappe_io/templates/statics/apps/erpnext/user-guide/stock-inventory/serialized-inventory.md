...
![Serial No Entry](files/serial-no-entry.png)
...
![Automatic Series](files/item-serial-no-series.png)

#### Step 2: Keep Serial No field blank in your entry

#### Step 3: Save / Submit your transaction (Serial Nos Automatically Updated)

![Serial No Created Message](files/serial-no-auto-1.png)

![Serial No Updated in Transaction](files/serial-no-auto-2.png)
